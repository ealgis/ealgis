    ...
    render() {
        ...
        return <div>
            <List style={styles.datasetSearchHeader}>
                ...
                <ListItem disabled={true} style={styles.datasetSearchHintTextListItem}>
                    <p style={styles.datasetSearchHintText}>
                        ...
                        <span style={styles.datasetSearchHintHighlight}>Hint:</span> If you want to lookup a column or table simply prefix your keywords with "column:" or "table:" e.g. "column:B117".
                    </p>
                </ListItem>
            </List>
            ...
            <ChipInput
                ...
                chipRenderer={({value, text, isFocused, isDisabled, handleClick, handleRequestDelete, defaultStyle}, key) => {
            ...
            {Object.keys(dataDiscovery).map((tableId: any, key: number) =>
                ...
                >
                    <CardHeader
                        title={`${dataDiscovery[tableId]["table"].metadata_json["type"]} (${dataDiscovery[tableId]["columns"].length})`}
                    ...
                    />
                    <CardText
                        style={styles.searchResultsCardText}
                        ...
                        <div style={styles.searchResultsReactList}>
                            <ReactList
                                itemRenderer={(index: any, key: any) => 
                                    <div key={key}>
                                        <Card
                                            style={styles.searchResultItemCard}
                                        >
                                            <CardHeader
                                                title={`${dataDiscovery[tableId]["columns"][key].metadata_json["kind"]} (${dataDiscovery[tableId]["columns"][key].name})`}
                                                subtitle={dataDiscovery[tableId]["columns"][key].metadata_json["type"]}
                                            ...
                                            <CardActions>
                                                <CopyToClipboard
                                                    ...
                                                    onCopy={() => onCopyToClipboard(dataDiscovery[tableId]["columns"][key].name)}
                                                >
                                                    <RaisedButton
                                                        label="Copy Column"
                                                        secondary={true}
                    ...
                    <CardActions>
                        <RaisedButton
                            ...
                            onTouchTap={
                                (evt: object) => 
                                    onTableLookup(dataDiscovery[tableId]["table"])
                            }
                        />
                    </CardActions>
                </Card>
