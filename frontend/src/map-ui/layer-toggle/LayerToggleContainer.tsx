...
import { changeLayerVisibility } from "../../redux/modules/maps"
    ...
    render() {
        ...
        return (
            <LayerToggle
                ...
                mapId={mapId}
                onToggle={() => onToggle(mapDefinition, layerId)}
            />
        )
    }
}
...
const LayerToggleContainerWrapped = connect(mapStateToProps, mapDispatchToProps)(LayerToggleContainer as any)
